...
<header class="site-header">
	...
	<div class="site-top">
		<div class="site-logo">
			<a href="${pageContext.request.contextPath}/"> <img
				src="${pageContext.request.contextPath}/images/title.png" alt="logo"
				class="logo-image">
			</a>
		</div>
			...
			<c:choose>
				<c:when test="${not empty sessionScope.loginUser}">
					<span class="user-welcome">
						${sessionScope.loginUser.userName}様、ようこそ </span>
	...
	<div class="site-search">
		<form class="form-inline justify-content-center" method="get"
			...
			<div class="input-group search-dark flex-nowrap">
				<input type="search" id="searchPlaceholder" name="keyword"
					class="form-control search-input rounded-left-pill" placeholder="">
	...
	<nav class="site-nav">
		<ul class="nav-menu">
			...
			<li><a
				href="${pageContext.request.contextPath}/service/nearshop.jsp">近所のグッズショップ</a></li>
			<li><a
				href="${pageContext.request.contextPath}/service/nearcafe.jsp">近所の開封スポット</a></li>
			<Li><a href="${pageContext.request.contextPath}/furima/list.do">フリマ</a></Li>
...
<script>
	(function() {
		var messages = [ "あなたの推しを探しに行きませんか？", "今回は無駄足にならないようにしましょう。",
				"私の推しは今どこにいるんだろう？", "友だちとランダム開封するなら、どこがいい？",
