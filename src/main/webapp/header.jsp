    ...
    <!-- Navigation -->
		<nav class="site-nav">
			<ul class="nav-menu">
				...
				<li><a href="${pageContext.request.contextPath}/service/nearshop.jsp">
						近所のグッズショップ </a></li>
				<li><a href="${pageContext.request.contextPath}/service/nearcafe.jsp">
						近所の開封スポット </a></li>
				<li><a href="${pageContext.request.contextPath}/furima/list.do">
						フリマ </a></li>
				<li><a href="${pageContext.request.contextPath}/board/list.do">
						雑談掲示板 </a></li>
			</ul>
		</nav>
